...
<!---------About-Us-------->
    <section class="about">
      ...
      <div class="row">
        <div class="about-col" >
          <img src="images2/hakim.jpeg">
          <div style="position: center;">
            <p>North East University of Bangladesh<br>DEPT. of CSE in BSc Enggenring <br>Semister: 12th</p>
            <h3>Abdul Hakim</h3>
...
<!--         <div class="about-col2">
        ...
        <!-- <div class="about-col">
          ...
          <div>
            <p>North East University of Bangladesh<br> DEPT. of CSE in BSc Enggenring <br>Semister: 8th<br>Section: B</p>
            <h3>Tanvir Ahmad</h3>
            <i class="fa fa-star"></i>
            <i class="fa fa-star"></i>
            <i class="fa fa-star"></i>
